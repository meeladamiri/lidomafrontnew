    ...
    >
      <div className="w-full h-[214px] relative">
        ...
        <div className="flex items-start justify-between absolute top-12 right-12 left-12">
          ...
          <div
            onClick={() => {
              if (!!onEditMainImageBtnClick) {
                onEditMainImageBtnClick();
              }
            }}
            className="w-40 h-40 flex items-center justify-center rounded-full bg-white cursor-pointer"
          >
...
export default ResidenceMainImage;
