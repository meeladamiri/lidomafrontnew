...
function ResidenceWaitingForExpertsConfirmCart({
  title,
  updateDate,
  completePercentage, // Rationally it is 100
  residenceId,
  link,
  residenceImage,
  ...
  return (
    <div className="rounded-12 border-gray-C4CAD3 border-1 border-solid flex">
      <div className="w-72 relative shrink-0">
        <div className="absolute z-1 top-0 right-0 left-0 bottom-0 flex items-center"></div>
        <Image
          src={residenceImage}
          alt=""
...
export default ResidenceWaitingForExpertsConfirmCart;
