...
function ConfirmedReserveBottomSheet({
  handleSmoothClose,
  residenceName,
  guestName,
  stayTime,
  ...
  return (
    <div>
      ...
      <Button
        isFullWidth
        rightIcon={<i className="icon-Phone text-black text-22" />}
        variant="outlined"
        color="black"
        rounded
        className="mb-12"
      ...
      <Button isFullWidth color="grey" rounded className="mb-12">
        مشاهده جزئیات رزرو
      </Button>
    </div>
  );
...
export default ConfirmedReserveBottomSheet;
