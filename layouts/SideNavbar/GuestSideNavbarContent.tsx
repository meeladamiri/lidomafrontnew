import { ISideNavbarItem, sideNavbarItems_ForGuestAccount } from "@/constants/SideNavbarItems";
...
function GuestSideNavbarContent({
...
export default GuestSideNavbarContent;
