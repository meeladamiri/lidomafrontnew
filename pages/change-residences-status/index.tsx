import ChangeResidencesStatus from "@/components/ChangeResidencesStatus";
import { PROJECTNAMEFA } from "configs/info";
import type { GetServerSideProps, NextPage } from "next";

const page = "تغییر وضعیت اقامتگاه";

const ChangeResidencesStatusPage: NextPage = () => {
  return (
    <>
      <ChangeResidencesStatus />
    </>
  );
};
...
export default ChangeResidencesStatusPage;
