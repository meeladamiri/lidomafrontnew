import SubmitReviewForMyTrip from "@/components/SubmitReviewForMyTrip";
import { PROJECTNAMEFA } from "@/configs/info";
import type { GetServerSideProps, NextPage } from "next";

const page = "ثبت نظر برای سفر";

const SubmitReviewForMyTripPage: NextPage = () => {
  return (
    <>
      <SubmitReviewForMyTrip />
    </>
  );
};
...
export default SubmitReviewForMyTripPage;
